...
| 4 | Landing page text-only minimal copy | **PARTIAL → this PR** | meta description + GIF alt + install-box (currently 2 lines) + comparison-table row + headache bullets all mention `PreToolUse` / `拦截`. |
