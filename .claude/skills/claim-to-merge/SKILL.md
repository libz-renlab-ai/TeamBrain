...
| 3 | driver | `.codex/worktrees/issue-<N>/` 起 `feat/issue-<N>`，按 grill 评论实现 | [.claude/skills/fixed-flow-driver/SKILL.md](../fixed-flow-driver/SKILL.md) |
...
| [.claude/skills/fixed-flow-driver/SKILL.md](../fixed-flow-driver/SKILL.md) | step 3-5 driver 实现细则；sanity gates、worktree、impl、/review loop、PR、merge |
