...
| **`PR proof images`** | 已合并 PR 的中文 proof-of-work 人审图评论；图片托管在 `LiuShiyuMath/teambrain-pr-proof-images`，marker 为 `teambrain-pr-proof-work:image:v1`（详见 `docs/PR-PROOF-IMAGE-COMMENTS.md`） |
